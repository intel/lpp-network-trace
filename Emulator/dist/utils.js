...
const validate = (function() {
  var pattern0 = new RegExp('^(-?(?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[01]|0[1-9]|[12][0-9])T(2[0-3]|[01][0-9]):([0-5][0-9]):([0-5][0-9])(.[0-9]{3})?(?:Z|[+-][01][0-9]:[0-5][0-9])?$');
  var refVal = [];
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    'use strict'; /*# sourceURL=http://example.com/product.schema.json */
    var vErrors = null;
    var errors = 0;
          ...
          if (valid1) {
            ...
            if (valid1) {
              ...
              if (valid1) {
                ...
                if (valid1) {
                  var data1 = data.dlBwTestDuration;
                  if (data1 === undefined) {
                    valid1 = true;
                  } else {
                    var errs_1 = errors;
                    if ((typeof data1 !== "number" || (data1 % 1) || data1 !== data1)) {
                      validate.errors = [{
                        keyword: 'type',
                        dataPath: (dataPath || '') + '.dlBwTestDuration',
                        schemaPath: '#/properties/dlBwTestDuration/type',
                        params: {
                          type: 'integer'
                        },
                        message: 'should be integer'
                    ...
                    if ((typeof data1 === "number")) {
                      if (data1 < 1 || data1 !== data1) {
                        validate.errors = [{
                          keyword: 'minimum',
                          dataPath: (dataPath || '') + '.dlBwTestDuration',
                          schemaPath: '#/properties/dlBwTestDuration/minimum',
                          params: {
                            comparison: '>=',
                            limit: 1,
                            exclusive: false
                  ...
                  if (valid1) {
                    var data1 = data.dlBwTestDownloadLimit;
                    if (data1 === undefined) {
                      valid1 = true;
                    } else {
                      var errs_1 = errors;
                      if ((typeof data1 !== "number" || (data1 % 1) || data1 !== data1)) {
                        validate.errors = [{
                          keyword: 'type',
                          dataPath: (dataPath || '') + '.dlBwTestDownloadLimit',
                          schemaPath: '#/properties/dlBwTestDownloadLimit/type',
                          params: {
                            type: 'integer'
                          },
                          message: 'should be integer'
                      ...
                      if ((typeof data1 === "number")) {
                        if (data1 < 1 || data1 !== data1) {
                          validate.errors = [{
                            keyword: 'minimum',
                            dataPath: (dataPath || '') + '.dlBwTestDownloadLimit',
                            schemaPath: '#/properties/dlBwTestDownloadLimit/minimum',
                            params: {
                              comparison: '>=',
                              limit: 1,
                              exclusive: false
                    ...
                    if (valid1) {
                      var data1 = data.dlBwTestUrl;
                      if (data1 === undefined) {
                        valid1 = true;
                      } else {
                        var errs_1 = errors;
                        if (typeof data1 === "string") {
                          if (ucs2length(data1) > 2048) {
                            validate.errors = [{
                              keyword: 'maxLength',
                              dataPath: (dataPath || '') + '.dlBwTestUrl',
                              schemaPath: '#/properties/dlBwTestUrl/maxLength',
                              params: {
                                limit: 2048
                              },
                              message: 'should NOT be longer than 2048 characters'
                            }];
                            return false;
                          } else {}
                        } else {
                          validate.errors = [{
                            keyword: 'type',
                            dataPath: (dataPath || '') + '.dlBwTestUrl',
                            schemaPath: '#/properties/dlBwTestUrl/type',
                            params: {
                              type: 'string'
                            },
                            message: 'should be string'
                      ...
                      if (valid1) {
                        var data1 = data.ulBwTestDuration;
                        if (data1 === undefined) {
                          valid1 = true;
                        } else {
                          var errs_1 = errors;
                          if ((typeof data1 !== "number" || (data1 % 1) || data1 !== data1)) {
                            validate.errors = [{
                              keyword: 'type',
                              dataPath: (dataPath || '') + '.ulBwTestDuration',
                              schemaPath: '#/properties/ulBwTestDuration/type',
                              params: {
                                type: 'integer'
                              },
                              message: 'should be integer'
                          ...
                          if ((typeof data1 === "number")) {
                            if (data1 < 1 || data1 !== data1) {
                              validate.errors = [{
                                keyword: 'minimum',
                                dataPath: (dataPath || '') + '.ulBwTestDuration',
                                schemaPath: '#/properties/ulBwTestDuration/minimum',
                                params: {
                                  comparison: '>=',
                                  limit: 1,
                                  exclusive: false
                        ...
                        if (valid1) {
                          var data1 = data.ulBwTestUploadLimit;
                          if (data1 === undefined) {
                            valid1 = true;
                          } else {
                            var errs_1 = errors;
                            if ((typeof data1 !== "number" || (data1 % 1) || data1 !== data1)) {
                              validate.errors = [{
                                keyword: 'type',
                                dataPath: (dataPath || '') + '.ulBwTestUploadLimit',
                                schemaPath: '#/properties/ulBwTestUploadLimit/type',
                                params: {
                                  type: 'integer'
                                },
                                message: 'should be integer'
                            ...
                            if ((typeof data1 === "number")) {
                              if (data1 < 1 || data1 !== data1) {
                                validate.errors = [{
                                  keyword: 'minimum',
                                  dataPath: (dataPath || '') + '.ulBwTestUploadLimit',
                                  schemaPath: '#/properties/ulBwTestUploadLimit/minimum',
                                  params: {
                                    comparison: '>=',
                                    limit: 1,
                                    exclusive: false
                                                              ...
                                                              if (valid4) {
                                                                if (data3.accuracy === undefined) {
                                                                  ...
                                                                  if ((typeof data3.accuracy !== "number")) {
                                                                    validate.errors = [{
                                                                      keyword: 'type',
                                                                      dataPath: (dataPath || '') + '.entries[' + i1 + '].gpsCoordinates.accuracy',
                                                                      schemaPath: '#/properties/entries/items/properties/gpsCoordinates/properties/accuracy/type',
                                                                      params: {
                                                                        type: 'number'
                                                                      },
                                                                      message: 'should be number'
